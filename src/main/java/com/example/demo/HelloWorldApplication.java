...
public class HelloWorldApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Endereco end1 = new Endereco(null, "Rua 1", "300", "Apt 1", "Bairro 1", "0213456789", cdd1, cli1);
		Endereco end2 = new Endereco(null, "Rua 2", "302", "Apt 2", "Bairro 2", "0213456789", cdd2, cli1);
