...
public class ProdutoService {
	...
	public Produto buscar(Integer id) throws ObjectNotFoundException {
		...
		return obj.orElseThrow(() -> 
			new ObjectNotFoundException("Não foi encontrada objeto de id "+ id + ". Tipo: " + Produto.class.getName()));
	}
	
	public void add(Produto C) {
		repositorio.save(C);
	}
	...
	public Page<Produto> buscar(String nome, List<Integer> ids, Integer page, Integer linesPerPage, String orderBy, String direction) {
		...
		return repositorio.buscar(nome, categorias, pageRequest);
	}
}
